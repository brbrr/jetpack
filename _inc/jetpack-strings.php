...
__( "Jetpack Backup {{em}}Daily{{/em}}", "jetpack" ), // _inc/client/plans/product-selector.jsx:39
__( "Jetpack Backup {{em}}Real-Time{{/em}}", "jetpack" ), // _inc/client/plans/product-selector.jsx:45
__( "Always-on backups ensure you never lose your site.", "jetpack" ), // _inc/client/plans/product-selector.jsx:59
__( "Always-on backups ensure you never lose your site. Your changes are saved as you edit and you have unlimited backup archives.", "jetpack" ), // _inc/client/plans/product-selector.jsx:60
__( "Included in your {{planLink}}Personal Plan{{/planLink}}", "jetpack" ), // _inc/client/plans/product-selector.jsx:93
__( "Included in your {{planLink}}Premium Plan{{/planLink}}", "jetpack" ), // _inc/client/plans/product-selector.jsx:104
__( "Included in your {{planLink}}Professional Plan{{/planLink}}", "jetpack" ), // _inc/client/plans/product-selector.jsx:115
__( "Solutions", "jetpack" ), // _inc/client/plans/product-selector.jsx:165
__( "Just looking for backups? We've got you covered.", "jetpack" ), // _inc/client/plans/product-selector.jsx:167
__( "Which backup option is best for me?", "jetpack" ), // _inc/client/plans/product-selector.jsx:178
...
__( "Continue", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:160
__( "Disconnect", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:164
__( "Disable", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:164
__( "Disconnect Jetpack", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:180
__( "Disable Jetpack", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:180
__( "Are you sure you want to disconnect?", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:198
__( "Are you sure you want to disconnect and deactivate?", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:199
__( "Cancel", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/dialog.jsx:202
...
__( "Always-on backups ensure you never lose your site.", "jetpack" ), // _inc/client/plans/single-product-backup/body.jsx:47
__( "Select a backup option:", "jetpack" ), // _inc/client/plans/single-product-backup/body.jsx:50
__( "Daily Backups", "jetpack" ), // _inc/client/plans/single-product-backup/index.jsx:24
__( "Real-Time Backups", "jetpack" ), // _inc/client/plans/single-product-backup/index.jsx:33
__( "Jetpack Backup", "jetpack" ), // _inc/client/plans/single-product-backup/index.jsx:65
__( "You are saving {{savings /}} by paying yearly", "jetpack" ), // _inc/client/plans/single-product-components/product-savings.jsx:27
